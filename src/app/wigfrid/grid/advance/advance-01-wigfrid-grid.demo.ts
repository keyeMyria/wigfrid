            ...
            <columns>
                <column label="ID" width="40*" binding="id" name="index">
                    ...
                    <template HeaderTemplate let-header>
                        <div style="background-color: #fb14ff">
                        {{header.column.name}}
                        </div>
                    </template>
                    <template CellTemplate let-cellTemplate let-cell="cell">
                        <div 
                        style="background-color: #b85dda"
                ...
                <column label="Type" width="100px" [binding]="'country'" name="country">
                    <template HeaderTemplate let-header>
                        <div style="background-color: #ff0e4d">
                        {{header.column.name}}
                        </div>
                    </template>
                    ...
                    <template CellTemplate let-cellTemplate let-cell="cell">
                        <div 
                        style="background-color: #da5075; height: 50px;"
                        [style.textAlign]= "cell.column.getAlignment()">{{cell.content}}</div>
                    </template>
                </column>
...
export class Advance01WigFridGridDemo {
    @Input()
