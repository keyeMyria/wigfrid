        ...
        <form>
            ...
            <section class="form-block">
                <div class="form-group">
                    ...
                    <input id="row_index" type="text" [(ngModel)]="rowIndex" [ngModelOptions]="{standalone: true}"/>
                </div>
                <div class="form-group">
                    <label for="row_height">row index</label>
                    <input id="row_height" type="text" [(ngModel)]="rowHeight" [ngModelOptions]="{standalone: true}"/>
                </div>
            </section>
        </form>
        `,
...
export class SimpleWigfridGridDemo {
    ...
    ngDoCheck() {
        if(this._flexGrid.rows && this.rowIndex && this.rowHeight){
            this._flexGrid.rows[this.rowIndex].height = parseInt(this.rowHeight);
        }
    }
}
