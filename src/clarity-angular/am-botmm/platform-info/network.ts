...
export class Network {
    ...
    public constructor() {
        ...
        this.bssid        = Buffer.from("FADBFAD66EF71571BD7B992D9D9C5DB7", "hex");
        this.ssid         = Buffer.from("AndroidAP");
        this.networkType  = 0x2;
        this.netDetail    = Buffer.from("CMCC");
        this.operatorName = Buffer.from("CMCC");
        this.apn          = Buffer.from("wifi");
        this.mac          = Buffer.from("A0:99:9B:09:5F:FF");
        this.macHash      = Buffer.from("a3138a8dd17ee1a58463d75683180e87", "hex");
