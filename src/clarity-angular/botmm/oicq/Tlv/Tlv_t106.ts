...
import "botmm/GradeeBundle/Oicq/Cypher/MD5";
...
class Tlv_t106 extends Tlv_t
{
    ...
    private  _getSSOV2(appid, subAppId, client_ver, uin, init_time, client_ip, seve_pwd, md5, TGTGT, readflg, guid)
    {
    ...
    private  _getSSOV3(appid, subAppId, client_ver, uin, init_time, client_ip, seve_pwd, md5, TGTGT, readflg, guid)
    {
        body = new Buffer(this._t106_body_len);
        p = 0;
        body.writeInt16BE(this._TGTGTVer, p);
     ...
     * @return mixed
     */
    private  _getSSOV5(appid, subAppId, client_ver, uin, init_time, client_ip, seve_pwd, md5, TGTGT, readflg, guid)
    {
        userAccount = strval(uin);
        body = new StreamOutputBuffer(new Buffer());
        body.writeInt16BE(this._TGTGTVer);
        //can be 4
        ...
        body.writeInt32BE(1);
        //1
        body.writeInt16BE(strlen(userAccount));
        //uin长度
