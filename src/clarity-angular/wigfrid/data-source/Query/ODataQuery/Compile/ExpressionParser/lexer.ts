...
import {NumberWrapper, StringJoiner, StringWrapper, isPresent} from '@angular/core/src/facade/lang';
...
export let EOF: Token = new Token(-1, TokenType.Character, 0, '');
