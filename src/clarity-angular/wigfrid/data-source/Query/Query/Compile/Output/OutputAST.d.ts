import { Type, MapType, ExternalType, TypeModifier } from "../Types";
...
export declare let THIS_EXPR: ReadVarExpr;
export declare let SUPER_EXPR: ReadVarExpr;
export declare let CATCH_ERROR_VAR: ReadVarExpr;
export declare let CATCH_STACK_VAR: ReadVarExpr;
